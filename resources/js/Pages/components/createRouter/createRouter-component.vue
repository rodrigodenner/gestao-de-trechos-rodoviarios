<template>
  <div class="bg-white p-4 rounded-lg shadow-md mb-4">
    <form class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
      <div>
      ...
      <div>
        <label for="rodovia" class="block text-sm font-medium text-gray-700">Rodovia</label>
        <select id="rodovia" name="rodovia"
                class="mt-1 block w-full bg-gray-100 border border-gray-300 rounded-md py-2 px-3 text-base leading-5">
          <!-- Opções -->
        </select>
      </div>
      <div>
        ...
        <input type="text" id="km-inicial" name="km-inicial"
               class="mt-1 block w-full bg-gray-100 border border-gray-300 rounded-md py-2 px-3 text-base leading-5">
      </div>
      <div>
        <label for="km-final" class="block text-sm font-medium text-gray-700">KM Final</label>
        <input type="text" id="km-final" name="km-final"
               class="mt-1 block w-full bg-gray-100 border border-gray-300 rounded-md py-2 px-3 text-base leading-5">
      </div>
      <div>
